...
private static boolean executeNext() {
	...
	else if (ev.node != Network.prototype && ev.node.isUp() )
	{
		...
		{
			try {
//                                System.err.println(CommonState.getTime()+" Event " +ev.node.getProtocol(pid).getClass()+ " PID "+pid);
				EDProtocol prot = (EDProtocol) ev.node.getProtocol(pid);
//                                System.err.println("Class " +prot.getClass());
//                                System.err.println(ev.node.getID());
//                                System.err.println(ev.event.getClass());
